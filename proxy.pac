...
function FindProxyForURL(url, host) {
    ...
    if (b == "com") {
        ...
        if (t == "4") {
            if (d(h, "clk1004.com") || d(h, "admtpmp124.com")) return BLACK;
        }
        if (t == "a") {
            if (z == "i") {
                if (d(h, "wigetmedia.com") || d(h, "lfstmedia.com") || d(h, "xtendmedia.com") || d(h, "vdopia.com") || d(h, "amazemobilemedia.com") || d(h, "tremormedia.com") || d(h, "cdn.millennialmedia.com") || d(h, "andomedia.com") || d(h, "conversantmedia.com") || d(h, "engine.a.redditmedia.com")) return BLACK;
            } else if (z == "v") {
        ...
        if (t == "e") {
            if (z == "c") {
                ...
                if (d(h, "swrve.com") || d(h, "pushnative.com") || d(h, "redirectnative.com") || d(h, "inner\u002Dactive.com") || d(h, "advertserve.com") || d(h, "adsnative.com")) return BLACK;
        ...
        if (t == "m") {
            if (z == "e") {
                if (d(h, "ir\u002Dna.amazon\u002Dadsystem.com") || d(h, "aax.amazon\u002Dadsystem.com") || d(h, "dra.amazon\u002Dadsystem.com") || d(h, "aax\u002Dus\u002Deast.amazon\u002Dadsystem.com") || d(h, "s.amazon\u002Dadsystem.com") || d(h, "api.unthem.com") || d(h, "aax\u002Deu.amazon\u002Dadsystem.com") || d(h, "c.amazon\u002Dadsystem.com") || d(h, "aax\u002Dus\u002Dpdx.amazon\u002Dadsystem.com")) return BLACK;
            } else if (d(h, "redtram.com") || d(h, "epom.com") || d(h, "ad131m.com") || d(h, "ad120m.com") || d(h, "adform.com") || d(h, "castplatform.com") || d(h, "gumgum.com") || d(h, "adnium.com") || d(h, "mdotm.com") || d(h, "ad127m.com") || d(h, "adcel.vrvm.com") || d(h, "ad132m.com")) return BLACK;
        }
        if (t == "l") {
            if (z == "a") {
        ...
        if (t == "s") {
            if (z == "d") {
                if (d(h, "onclkds.com") || d(h, "juicyads.com") || d(h, "bcfads.com") || d(h, "beaverads.com") || d(h, "exoticads.com") || d(h, "marsads.com") || d(h, "buysellads.com") || d(h, "moatads.com") || d(h, "appads.com") || d(h, "mads.com") || d(h, "mobile.aws.weather.com") && s(u, "*/ads.json") || d(h, "tapjoyads.com") || d(h, "carbonads.com") || d(h, "hotwords.com") || d(h, "mellowads.com") || d(h, "1phads.com") || d(h, "ketads.com") || d(h, "openvideoads.com") || d(h, "pflexads.com") || d(h, "mng\u002Dads.com") || d(h, "medyanetads.com") || d(h, "youtube.com") && s(u, "*/_get_ads*") || d(h, "zestads.com") || d(h, "propellerads.com")) return BLACK;
            } else if (z == "k") {
                if (d(h, "ecpmrocks.com") || d(h, "adtaxinetworks.com") || d(h, "hkg1.aastocks.com") || d(h, "mobtrks.com") || d(h, "mobytrks.com") || d(h, "terraclicks.com") || d(h, "infolinks.com") || d(h, "ox\u002Dd.majorgeeks.com") || d(h, "yumenetworks.com") || d(h, "keywordblocks.com")) return BLACK;
            } else if (z == "t") {
        ...
        if (t == "r") {
            if (z == "e") {
                if (d(h, "kixer.com") || d(h, "wwwpromoter.com") || d(h, "yieldmanager.com") || d(h, "eyewonder.com") || d(h, "adkeeper.com") || !s(u, "*/click*") && !s(u, "*itunesredir*") && d(h, "tradedoubler.com") || d(h, "liveadexchanger.com") || d(h, "bidvertiser.com") || d(h, "fyber.com") || d(h, "applifier.com") || d(h, "mob\u002Dserver.com") || d(h, "smartadserver.com") || d(h, "ad\u002Dcenter.com")) return BLACK;
            } else if (z == "o") {
        ...
        if (t == "t") {
            ...
            } else if (d(h, "rubiconproject.com") || d(h, "questionmarket.com") || d(h, "adsmarket.com") || d(h, "appsdt.com") || d(h, "lijit.com") || d(h, "mobiright.com") || d(h, "atdmt.com") || !s(u, "*configure*") && d(h, "adtilt.com") || d(h, "leadbolt.com") || d(h, "avocarrot.com") || d(h, "apprupt.com") || d(h, "chartboost.com") || d(h, "admost.com") || d(h, "reklamport.com") || d(h, "adexprt.com") || d(h, "scanscout.com") || d(h, "intellitxt.com") || d(h, "appnext.com")) return BLACK;
        }
        if (t == "w") {
